...
<DefaultPageLayout content={{ title: frontmatter.title, description: frontmatter.description }}>
    <Prose>
        **Açık Yazılım Ağı** (AYA), sosyal bir yarar oluşturmak motivasyonuyla nitelikli bilişim çözümleri
        ...
        projeleri barındıran [yazılım vakfı kimliğiyle](/blog/20240107-vakif-kimligimiz-ve-sinirlarimiz)
        devam ediyor.
        ...
        Ancak [bu süreçte](/blog/20230217-acik-yazilim-agi-ve-6-subat) edindiğimiz deneyim bizlere gösterdi
