...
<DefaultPageLayout content={{ title: frontmatter.title, description: frontmatter.description }}>
    <Prose>
        **Açık Yazılım Ağı** (AYA), sosyal bir yarar oluşturmak motivasyonuyla nitelikli bilişim çözümleri
        ...
        oldular. Bizim buradaki rolümüz hem iletişime aracı olmak hem de kaynak yönetiminde koordinasyon
        sağlamak oldu.
        ...
        Bu nedenle amacımızı revize ederek, geçmişte [Açık Kaynak İnisiyatifi](https://acik.io)nin
